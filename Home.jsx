...
export default function Home() {return <>
  <section className="hero container">
    <div><span className="eyebrow">Donosend Pilot · Pro Vita Animale</span><h1>Verkaufen, bezahlen und dabei sichtbar Tieren helfen.</h1><p>Jonas startet den ersten Donosend-Test: Ein QR-Code, ein 1,00-€-Testbeitrag und eine klare Zuordnung zu Pro Vita Animale e.V. – zunächst als unverbindliche Demo-Präsentation.</p><div className="actions"><Link className="button primary" to="/profil/jonas">Jonas-Profil öffnen <QrCode size={18}/></Link><Link className="button ghost" to="/organisationen">Pro Vita Animale ansehen <ArrowRight size={18}/></Link></div><div className="trust-row"><span><BadgeCheck size={18}/> Klare Demo-Kennzeichnung</span><span><CreditCard size={18}/> Stripe Sandbox</span></div></div>
